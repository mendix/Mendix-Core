 ...
 *******************************************************************************/
package org.mendix.common.generator.admin;
...
public class Mod4jTracker {
    ...
    static private Mod4jTracker mendixTracker = null;
    ...
    static public Mod4jTracker getFileTracker() {
        if (mendixTracker == null) {
            mendixTracker = new Mod4jTracker();
        }
        return mendixTracker;
    }
