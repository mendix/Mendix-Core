...
public class ConfigurationException extends RuntimeException {
    ...
    /**
     * Constructs a new configuration exception with <code>null</code> as its detail message. The cause is not
     ...
     * <tt>cause</tt>). This constructor is useful for configuration exceptions that are little more than wrappers
