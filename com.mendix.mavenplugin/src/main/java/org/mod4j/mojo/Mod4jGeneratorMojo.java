...
import org.mendix.dslcommon.io.DirectoryWalker;
import org.mendix.dslcommon.openarchitectureware.CodegenDirectoryVisitor;
import org.mendix.dslcommon.openarchitectureware.CrossxDirectoryVisitor;
...
public class Mod4jGeneratorMojo extends AbstractMojo {
     ...
     * 
     * @parameter default-value="mendix.properties"
     */
    private final String generatorPropertiesFileName = "mendix.properties";
    ...
    private void addDefaultDslExtensions() {
        ...
        dslExtensions.add(new DslExtension("Mod4j", "DataContractDsl",
                "org.mendix.dsl.datacontract.mm.DataContractDsl.DataContractDslPackage", ".dtcmod",
                "org/mendix/dsl/datacontract/generator/workflow/dtcmod2crossx.oaw",
                "org/mendix/dsl/datacontract/generator/workflow/DataContractDsl.oaw", generatorPropertiesFileName));

        dslExtensions.add(new DslExtension("Mod4j", "ServiceDsl",
                "org.mendix.dsl.service.mm.ServiceDsl.ServiceDslPackage", ".sermod", 
                "org/mendix/dsl/service/generator/workflow/sermod2crossx.oaw",
                "org/mendix/dsl/service/generator/workflow/ServiceDsl.oaw", generatorPropertiesFileName));
        }
