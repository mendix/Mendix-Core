 ...
 * <ul>
 *   <li>{@link BusinessDomainDsl.impl.ModelElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link BusinessDomainDsl.impl.ModelElementImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case BusinessDomainDslPackage.MODEL_ELEMENT__NAME:
                return getName();
            case BusinessDomainDslPackage.MODEL_ELEMENT__DESCRIPTION:
