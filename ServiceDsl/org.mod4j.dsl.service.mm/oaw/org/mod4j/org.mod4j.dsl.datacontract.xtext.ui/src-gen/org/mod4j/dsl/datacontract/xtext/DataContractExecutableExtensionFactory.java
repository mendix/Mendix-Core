 ...
 * generated
 */
public class DataContractExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(DataContractExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		org.mendix.dsl.datacontract.xtext.internal.DataContractActivator instance = org.mendix.dsl.datacontract.xtext.internal.DataContractActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = org.mendix.dsl.datacontract.xtext.internal.DataContractActivator.getInstance().getInjector("org.mendix.dsl.datacontract.xtext.DataContract");
